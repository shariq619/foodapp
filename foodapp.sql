...
/*Data for the table `accommodations` */

insert  into `accommodations`(`id`,`name`,`image`,`user_id`) values (2,'Hollee Griffin','platzhalere-300x185.png',5),(3,'aa','WhatsApp Image 2024-04-01 at 3.24.31 AM (2).jpeg',2),(4,'ww','',2);
